...
INSERT INTO "new_Booking" ("createdAt", "customerPhone", "day", "id", "priceChargedCents", "serviceId", "tenantId", "time") SELECT "createdAt", "customerPhone", "day", "id", "priceChargedCents", "serviceId", "tenantId", "time" FROM "Booking";
DROP TABLE "Booking";
